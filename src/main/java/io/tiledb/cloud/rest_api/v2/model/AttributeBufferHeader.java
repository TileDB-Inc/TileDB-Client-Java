...
public class AttributeBufferHeader {
   ...
   * @return the AttributeBufferHeader instance itself
   */
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttributeBufferHeader
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttributeBufferHeader.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
