...
public class NotebookUploaded {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotebookUploaded.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotebookUploaded' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotebookUploaded> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotebookUploaded.class));

       return (TypeAdapter<T>) new TypeAdapter<NotebookUploaded>() {
           @Override
