...
public class FloatScaleConfig {
  ...
  public static final String SERIALIZED_NAME_BYTE_WIDTH = "byteWidth";
  ...
  public boolean equals(Object o) {
    ...
    FloatScaleConfig floatScaleConfig = (FloatScaleConfig) o;
    return Objects.equals(this.scale, floatScaleConfig.scale) &&
        Objects.equals(this.offset, floatScaleConfig.offset) &&
        Objects.equals(this.byteWidth, floatScaleConfig.byteWidth)&&
        Objects.equals(this.additionalProperties, floatScaleConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scale, offset, byteWidth, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FloatScaleConfig {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatScaleConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatScaleConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatScaleConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatScaleConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatScaleConfig>() {
           @Override
