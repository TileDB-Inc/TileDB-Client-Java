...
public class FilterData {
  ...
  public FilterData addBytesItem(Integer bytesItem) {
    if (this.bytes == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.text, filterData.text) &&
        Objects.equals(this.bytes, filterData.bytes) &&
        Objects.equals(this.int8, filterData.int8) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(text, bytes, int8, uint8, int16, uint16, int32, uint32, int64, uint64, float32, float64, additionalProperties);
  }
