...
import io.tiledb.cloud.rest_api.v2.model.MapFloat64;
import io.tiledb.cloud.rest_api.v2.model.MapUInt64;
...
public class Stats {
  ...
  public MapFloat64 getTimers() {
    return timers;
  }

  public void setTimers(MapFloat64 timers) {
    this.timers = timers;
  }


  public Stats counters(MapUInt64 counters) {
   ...
   */
  @javax.annotation.Nullable
  public MapUInt64 getCounters() {
    return counters;
  }

  public void setCounters(MapUInt64 counters) {
    this.counters = counters;
  }
   ...
   * @return the Stats instance itself
   */
  public Stats putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Stats stats = (Stats) o;
    return Objects.equals(this.timers, stats.timers) &&
        Objects.equals(this.counters, stats.counters)&&
        Objects.equals(this.additionalProperties, stats.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timers, counters, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Stats>() {
           ...
           public Stats read(JsonReader in) throws IOException {
             ...
             Stats instance = thisAdapter.fromJsonTree(jsonObj);
