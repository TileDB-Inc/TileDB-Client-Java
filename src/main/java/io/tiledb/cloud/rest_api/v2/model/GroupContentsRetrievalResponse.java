...
public class GroupContentsRetrievalResponse {
  ...
  public GroupContentsRetrievalResponse addMembersItem(GroupMember membersItem) {
  ...
  public boolean equals(Object o) {
    ...
    GroupContentsRetrievalResponse groupContentsRetrievalResponse = (GroupContentsRetrievalResponse) o;
    return Objects.equals(this.members, groupContentsRetrievalResponse.members) &&
        Objects.equals(this.metadata, groupContentsRetrievalResponse.metadata)&&
        Objects.equals(this.additionalProperties, groupContentsRetrievalResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(members, metadata, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupContentsRetrievalResponse {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupContentsRetrievalResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupContentsRetrievalResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupContentsRetrievalResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupContentsRetrievalResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupContentsRetrievalResponse>() {
           @Override
