...
public class TileDBConfig {
  ...
  private List<TileDBConfigEntriesInner> entries = new ArrayList<>();

  public TileDBConfig() {
  }

  public TileDBConfig entries(List<TileDBConfigEntriesInner> entries) {
    this.entries = entries;
    return this;
  }

  public TileDBConfig addEntriesItem(TileDBConfigEntriesInner entriesItem) {
  ...
  public List<TileDBConfigEntriesInner> getEntries() {
    return entries;
  }

  public void setEntries(List<TileDBConfigEntriesInner> entries) {
    this.entries = entries;
  }
   ...
   * @return the TileDBConfig instance itself
   */
  public TileDBConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entries, tileDBConfig.entries)&&
        Objects.equals(this.additionalProperties, tileDBConfig.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TileDBConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TileDBConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TileDBConfig>() {
           ...
           public TileDBConfig read(JsonReader in) throws IOException {
             ...
             TileDBConfig instance = thisAdapter.fromJsonTree(jsonObj);
