...
import io.tiledb.cloud.rest_api.v4.model.TeamspaceGetResponse;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUpdateRequest;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUserGetResponse;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUserUpdateRequest;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUsersBulkUpdateRequestInner;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUsersCreateRequestInner;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUsersCreateResponse;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUsersJoinResponse;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUsersListResponse;
import io.tiledb.cloud.rest_api.v4.model.TeamspacesCreateRequest;
import io.tiledb.cloud.rest_api.v4.model.TeamspacesCreateResponse;
import io.tiledb.cloud.rest_api.v4.model.TeamspacesListResponse;
...
public class TeamspacesApi {
     ...
     * @param workspace The workspace name or id (required)
     * @param teamspace The teamspace name or id (required)
     * @param deleteAssets If &#x60;true&#x60;, the entity&#39;s assets will be deregistered in TileDB *and* deleted from the underlying storage (e.g., S3). If &#x60;false&#x60;, the entity&#39;s assets will be deregistered in TileDB but remain in the underlying storage.  (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteTeamspaceCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nullable Boolean deleteAssets, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (deleteAssets != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("delete-assets", deleteAssets));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTeamspaceValidateBeforeCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nullable Boolean deleteAssets, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspace' is set
        if (workspace == null) {
        ...
        return deleteTeamspaceCall(workspace, teamspace, deleteAssets, _callback);
     ...
     */
    public void deleteTeamspace(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nullable Boolean deleteAssets) throws ApiException {
        deleteTeamspaceWithHttpInfo(workspace, teamspace, deleteAssets);
    }
     ...
     */
    public ApiResponse<Void> deleteTeamspaceWithHttpInfo(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nullable Boolean deleteAssets) throws ApiException {
        okhttp3.Call localVarCall = deleteTeamspaceValidateBeforeCall(workspace, teamspace, deleteAssets, null);
     ...
     */
    public okhttp3.Call deleteTeamspaceAsync(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nullable Boolean deleteAssets, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteTeamspaceValidateBeforeCall(workspace, teamspace, deleteAssets, _callback);
     ...
     * @param memberships If true, returns teamspaces the user is a member of. If false, returns public teamspaces in the workspace that the user is NOT a member of.  (optional, default to true)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listTeamspacesCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable String orderBy, @javax.annotation.Nullable String order, @javax.annotation.Nullable Boolean memberships, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listTeamspacesValidateBeforeCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable String orderBy, @javax.annotation.Nullable String order, @javax.annotation.Nullable Boolean memberships, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspace' is set
        if (workspace == null) {
            throw new ApiException("Missing the required parameter 'workspace' when calling listTeamspaces(Async)");
        }

        return listTeamspacesCall(workspace, orderBy, order, memberships, _callback);
     ...
     */
    public TeamspacesListResponse listTeamspaces(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable String orderBy, @javax.annotation.Nullable String order, @javax.annotation.Nullable Boolean memberships) throws ApiException {
        ApiResponse<TeamspacesListResponse> localVarResp = listTeamspacesWithHttpInfo(workspace, orderBy, order, memberships);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TeamspacesListResponse> listTeamspacesWithHttpInfo(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable String orderBy, @javax.annotation.Nullable String order, @javax.annotation.Nullable Boolean memberships) throws ApiException {
        okhttp3.Call localVarCall = listTeamspacesValidateBeforeCall(workspace, orderBy, order, memberships, null);
        Type localVarReturnType = new TypeToken<TeamspacesListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve teamspaces in the workspace (asynchronously)
     * If &#x60;memberships&#x3D;true&#x60;, fetches teamspaces the user is a member of. If &#x60;memberships&#x3D;false&#x60;, fetches public teamspaces the user is not a member of. 
     * @param workspace The workspace name or id (required)
     * @param orderBy The field to order the results by. Defaults to &#x60;created_at&#x60;. Can be one of the following: - name - created_at - updated_at  (optional)
     * @param order Specifies the sorting direction for the results returned by the query. Defaults to &#x60;desc&#x60;. Can be one of the following: - asc - desc  (optional)
     ...
     */
    public okhttp3.Call listTeamspacesAsync(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable String orderBy, @javax.annotation.Nullable String order, @javax.annotation.Nullable Boolean memberships, final ApiCallback<TeamspacesListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTeamspacesValidateBeforeCall(workspace, orderBy, order, memberships, _callback);
        Type localVarReturnType = new TypeToken<TeamspacesListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
