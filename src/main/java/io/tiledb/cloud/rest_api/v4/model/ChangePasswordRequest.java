...
public class ChangePasswordRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("current_password", "new_password"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("current_password", "new_password"));
  }
