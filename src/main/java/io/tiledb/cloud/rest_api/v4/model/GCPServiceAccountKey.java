...
public class GCPServiceAccountKey {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("account_id", "key_id", "key_text"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("account_id", "key_id", "key_text"));
  }
