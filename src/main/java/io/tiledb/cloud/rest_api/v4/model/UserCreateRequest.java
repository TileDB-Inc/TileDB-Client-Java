...
public class UserCreateRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("display_name", "email", "username", "password", "timezone", "image"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("email", "username", "password"));
  }
