...
import io.tiledb.cloud.rest_api.v4.model.InvitationWorkspace;
import io.tiledb.cloud.rest_api.v4.model.InvitingUser;
...
public class Invitation {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("invitation_id", "invitee_email", "created_by", "created_at", "workspace_invitation"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("invitation_id", "invitee_email", "created_by", "created_at"));
  }
