...
import io.tiledb.cloud.rest_api.v4.model.CommonPrefix;
import io.tiledb.cloud.rest_api.v4.model.ModelObject;
...
public class FileListResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("Name", "Prefix", "Delimiter", "MaxKeys", "ContinuationToken", "NextContinuationToken", "IsTruncated", "CommonPrefixes", "Objects"));
