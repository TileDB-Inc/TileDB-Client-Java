...
public class Folder {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "workspace_id", "teamspace_id", "group_id", "asset_id", "parent_folder_id", "name", "created_at", "updated_at", "created_by", "description"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "workspace_id", "teamspace_id", "asset_id", "name", "created_at", "created_by"));
  }
