...
public class ShareItem {
  ...
  public ShareItem name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ShareItem id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, shareItem.name) &&
        Objects.equals(this.id, shareItem.id);
  }
