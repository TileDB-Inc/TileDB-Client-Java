...
public class Userspace {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("userspace_id", "name", "icon", "created_at", "description", "updated_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("userspace_id", "name", "created_at"));
  }
