...
public class AcademyLesson {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lesson_id", "lesson_version", "completed", "pinned"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("lesson_id", "lesson_version"));
  }
