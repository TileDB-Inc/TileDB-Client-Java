...
import io.tiledb.cloud.rest_api.v4.model.ValidationError;
...
public class Error {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "message", "request_id", "validation_error"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("code", "message", "request_id"));
  }
