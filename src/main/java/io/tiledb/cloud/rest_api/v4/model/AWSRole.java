...
public class AWSRole {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("role_arn", "external_id", "endpoint"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("role_arn", "external_id"));
  }
