...
public class TokenListResponse {
  ...
  public TokenListResponse data(@javax.annotation.Nonnull List<APIToken> data) {
    this.data = data;
    return this;
  }

  public TokenListResponse addDataItem(APIToken dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nonnull List<APIToken> data) {
    this.data = data;
  }


  public TokenListResponse paginationMetadata(@javax.annotation.Nullable PaginationMetadata paginationMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, tokenListResponse.data) &&
        Objects.equals(this.paginationMetadata, tokenListResponse.paginationMetadata);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TokenListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        APIToken.validateJsonElement(jsonArraydata.get(i));
      };
