...
import io.tiledb.cloud.rest_api.v4.model.WorkspaceCreateRequest;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceCreateResponse;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceGetResponse;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceUpdateRequest;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceUserGetResponse;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceUserUpdateRequest;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceUsersBulkUpdateRequestInner;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceUsersCreateRequestInner;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceUsersCreateResponse;
import io.tiledb.cloud.rest_api.v4.model.WorkspaceUsersListResponse;
...
public class WorkspacesApi {
     ...
     * @param search Search filter to find users by username or email (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listWorkspaceUsersCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer perPage, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listWorkspaceUsersValidateBeforeCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer perPage, @javax.annotation.Nullable String search, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspace' is set
        if (workspace == null) {
            throw new ApiException("Missing the required parameter 'workspace' when calling listWorkspaceUsers(Async)");
        }

        return listWorkspaceUsersCall(workspace, page, perPage, search, _callback);
     ...
     */
    public WorkspaceUsersListResponse listWorkspaceUsers(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer perPage, @javax.annotation.Nullable String search) throws ApiException {
        ApiResponse<WorkspaceUsersListResponse> localVarResp = listWorkspaceUsersWithHttpInfo(workspace, page, perPage, search);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkspaceUsersListResponse> listWorkspaceUsersWithHttpInfo(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer perPage, @javax.annotation.Nullable String search) throws ApiException {
        okhttp3.Call localVarCall = listWorkspaceUsersValidateBeforeCall(workspace, page, perPage, search, null);
     ...
     */
    public okhttp3.Call listWorkspaceUsersAsync(@javax.annotation.Nonnull String workspace, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer perPage, @javax.annotation.Nullable String search, final ApiCallback<WorkspaceUsersListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listWorkspaceUsersValidateBeforeCall(workspace, page, perPage, search, _callback);
        Type localVarReturnType = new TypeToken<WorkspaceUsersListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
