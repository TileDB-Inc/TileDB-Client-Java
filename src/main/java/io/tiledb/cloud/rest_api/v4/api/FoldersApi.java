...
import io.tiledb.cloud.rest_api.v4.model.FolderContentsResponse;
import io.tiledb.cloud.rest_api.v4.model.FolderCreateRequestInner;
import io.tiledb.cloud.rest_api.v4.model.FolderCreateResponse;
import io.tiledb.cloud.rest_api.v4.model.FolderGetResponse;
import io.tiledb.cloud.rest_api.v4.model.FolderUpdateRequest;
import io.tiledb.cloud.rest_api.v4.model.FoldersContentsModifyInner;
...
public class FoldersApi {
     ...
     */
    public okhttp3.Call deleteFolderCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String folder, @javax.annotation.Nullable Boolean deleteAssets, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteFolderValidateBeforeCall(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String folder, @javax.annotation.Nullable Boolean deleteAssets, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workspace' is set
        if (workspace == null) {
        ...
        return deleteFolderCall(workspace, teamspace, folder, deleteAssets, _callback);
     ...
     */
    public void deleteFolder(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String folder, @javax.annotation.Nullable Boolean deleteAssets) throws ApiException {
        deleteFolderWithHttpInfo(workspace, teamspace, folder, deleteAssets);
    }
     ...
     */
    public ApiResponse<Void> deleteFolderWithHttpInfo(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String folder, @javax.annotation.Nullable Boolean deleteAssets) throws ApiException {
        okhttp3.Call localVarCall = deleteFolderValidateBeforeCall(workspace, teamspace, folder, deleteAssets, null);
     ...
     */
    public okhttp3.Call deleteFolderAsync(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String folder, @javax.annotation.Nullable Boolean deleteAssets, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteFolderValidateBeforeCall(workspace, teamspace, folder, deleteAssets, _callback);
