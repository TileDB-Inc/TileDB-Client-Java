...
public class AWSCredential {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access_key_id", "secret_access_key", "endpoint"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("access_key_id", "secret_access_key"));
  }
