...
public class PaginationMetadata {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("page", "per_page", "total_pages", "total_items"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("page", "per_page", "total_pages", "total_items"));
  }
