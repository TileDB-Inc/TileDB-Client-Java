...
public class RestCapabilities {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("deployedTileDBVersion", "minimumSupportedTileDBClientVersion"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("deployedTileDBVersion", "minimumSupportedTileDBClientVersion"));
  }
