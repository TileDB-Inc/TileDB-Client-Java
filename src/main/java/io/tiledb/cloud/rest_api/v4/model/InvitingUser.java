...
public class InvitingUser {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("user_id", "display_name", "email", "image_id", "workspace_role"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("user_id", "display_name", "email", "workspace_role"));
  }
