...
import io.tiledb.cloud.rest_api.v4.model.UserRole;
...
public class User {
  ...
  public User deletedAt(@javax.annotation.Nullable OffsetDateTime deletedAt) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, displayName, imageId, email, isValidEmail, role, username, timezone, createdAt, updatedAt, deletedAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "display_name", "image_id", "email", "is_valid_email", "role", "username", "timezone", "created_at", "updated_at", "deleted_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "display_name", "email", "role", "username", "timezone", "created_at"));
  }
