...
import io.tiledb.cloud.rest_api.v4.model.ErrorXML;
import java.io.File;
import io.tiledb.cloud.rest_api.v4.model.FileListResponse;
...
public class FilesApi {
     ...
     */
    public File fileHead(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String path) throws ApiException {
        ApiResponse<File> localVarResp = fileHeadWithHttpInfo(workspace, teamspace, path);
     ...
     */
    public ApiResponse<File> fileHeadWithHttpInfo(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String path) throws ApiException {
     ...
     */
    public okhttp3.Call fileHeadAsync(@javax.annotation.Nonnull String workspace, @javax.annotation.Nonnull String teamspace, @javax.annotation.Nonnull String path, final ApiCallback<File> _callback) throws ApiException {
