...
public class ErrorResponse {
  ...
  public ErrorResponse errorCode(@javax.annotation.Nonnull Integer errorCode) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("errorCode", "message"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("errorCode", "message"));
  }
