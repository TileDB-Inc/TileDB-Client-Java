...
import io.tiledb.cloud.rest_api.v4.model.TeamspaceType;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceUser;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceVisibility;
...
public class Teamspace {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("teamspace_id", "name", "space_type", "icon", "created_at", "created_by", "description", "self", "visibility", "updated_at"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("teamspace_id", "name", "space_type", "created_at", "created_by", "visibility"));
  }
