...
import io.tiledb.cloud.rest_api.v4.model.TokenScope;
...
public class APIToken {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("token_id", "name", "created_at", "expires_at", "api_key", "workspace_id", "scope"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("token_id", "name", "created_at", "expires_at", "api_key", "scope"));
  }
