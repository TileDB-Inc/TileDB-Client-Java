...
import io.tiledb.cloud.rest_api.v4.model.StorageSettingsForTeamspaceCreateRequest;
import io.tiledb.cloud.rest_api.v4.model.TeamspaceDefaultCredential;
...
public class TeamspacesCreateRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "icon", "visibility", "default_credential", "default_storage_setting"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "visibility"));
  }
