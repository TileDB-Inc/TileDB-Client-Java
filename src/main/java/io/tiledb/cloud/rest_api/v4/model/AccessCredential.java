...
import io.tiledb.cloud.rest_api.v4.model.CredentialType;
...
public class AccessCredential {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("credential_type", "id", "name", "provider", "provider_default", "created_at", "updated_at", "allowed_in_tasks", "credential", "role", "token"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("credential_type", "id", "name", "provider", "created_at"));
  }
