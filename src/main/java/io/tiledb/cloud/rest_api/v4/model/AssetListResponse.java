...
public class AssetListResponse {
  ...
  public AssetListResponse data(@javax.annotation.Nonnull List<Asset> data) {
    this.data = data;
    return this;
  }

  public AssetListResponse addDataItem(Asset dataItem) {
    if (this.data == null) {
  ...
  public AssetListResponse paginationMetadata(@javax.annotation.Nonnull PaginationMetadata paginationMetadata) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : AssetListResponse.openapiRequiredFields) {
