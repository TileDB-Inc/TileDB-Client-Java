...
import io.tiledb.cloud.rest_api.v4.model.CloudProvider;
import io.tiledb.cloud.rest_api.v4.model.CredentialCreateRequest;
import io.tiledb.cloud.rest_api.v4.model.CredentialGetResponse;
import io.tiledb.cloud.rest_api.v4.model.CredentialUpdateRequest;
import io.tiledb.cloud.rest_api.v4.model.CredentialsListResponse;
import io.tiledb.cloud.rest_api.v4.model.CredentialsVerifyRequest;
...
public class CredentialsApi {
     ...
     */
    public okhttp3.Call verifyCredentialCall(@javax.annotation.Nonnull CredentialsVerifyRequest credentialsVerifyRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/actions/credentials/verify";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call verifyCredentialValidateBeforeCall(@javax.annotation.Nonnull CredentialsVerifyRequest credentialsVerifyRequest, final ApiCallback _callback) throws ApiException {
        ...
        return verifyCredentialCall(credentialsVerifyRequest, _callback);
     ...
     */
    public void verifyCredential(@javax.annotation.Nonnull CredentialsVerifyRequest credentialsVerifyRequest) throws ApiException {
        verifyCredentialWithHttpInfo(credentialsVerifyRequest);
    }
     ...
     */
    public ApiResponse<Void> verifyCredentialWithHttpInfo(@javax.annotation.Nonnull CredentialsVerifyRequest credentialsVerifyRequest) throws ApiException {
        okhttp3.Call localVarCall = verifyCredentialValidateBeforeCall(credentialsVerifyRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call verifyCredentialAsync(@javax.annotation.Nonnull CredentialsVerifyRequest credentialsVerifyRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = verifyCredentialValidateBeforeCall(credentialsVerifyRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
